...
-(NSArray *)applicationResourceDirectoryList:(NSString *)inStrSubdirectory
{
	NSString *strSubDirPath = \
		[NSString stringWithFormat:@"/%@",inStrSubdirectory];
	NSError *error = nil;
	NSArray *arrContentList = \
		[[NSFileManager defaultManager]
		 contentsOfDirectoryAtPath:
			 [[[NSBundle mainBundle] 
			   resourcePath] 
			  stringByAppendingString:strSubDirPath]
		 error:&error];
